...
const Block = ({ text, onClick, img, classes }) => {
    ...
    return (
        <div className={`sm:py-6 sm:px-4 p-3  grid place-items-center block-item rounded-lg cursor-pointer  ${classes ? classes : 'lightblue-bg w-36 sm:w-52'}`} onClick={onClick}>
