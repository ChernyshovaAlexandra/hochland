            ...
            <div className="sm:flex h-full">
                <div className="flex-1 p-8 -mr-24 sm:w-3/12 w-full relative z-20 main-text">
                    ...
                    <div  onClick={() => setPage('rules')}
                        className="sm:bg-transparent bg-blue p-2 absolute bottom-6 min-[766px]:bottom-16 text-white underline hover:no-underline text-reg cursor-pointer">Правила акции</div>
                </div>
